...
\begin{description}
\item[/LFXXXX/]gleiche Frage \ *\textit{Muss-Ziel}*\\
 Jeder Spieler der Gruppe bekommt gleichzeitig die gleiche Frage bestellt.
\item[/LFXXXX/]Punkteausschüttung der Frage \ *\textit{Muss-Ziel}* \\
...
\item[/LFXXXX/]Jackpot-Frage\ *\textit{Muss-Ziel}*\\
...
\item[/LFXXXX/] Punkteausschüttung einer Jackpot-Frage \ *\textit{Muss-Ziel}* \\
...
\item[/LFXXXX/] Auftrittswahrscheinlichkeit einer Jackpot-Frage \ *\textit{Muss-Ziel}*\\
...
\item[/LFXXXX/] Neufüllung des Jackpots nach Leerung \ *\textit{Muss-Ziel}* \\
...
\item[/LFXXXX/]letzte Frage einer Spielrunde \ *\textit{Muss-Ziel}* \\
...
\item[/LFXXXX/] Punktzahl einer Frage \ *\textit{Muss-Ziel}* \\
