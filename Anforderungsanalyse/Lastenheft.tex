...
Diese sind entweder alle bereits verfügbar und können vor dem Spielstart ausgewählt werden, oder werden durch Badges freigespielt. Die Verwaltung, d.h. Erstellung, Veränderung, Löschung obliegt dem Administrator.
\end{description}
